    ...
    when not matched
     and DBT_INTERNAL_SOURCE.dbt_change_type = 'insert'
        then insert ("WATCHLIST_ID", "ENTITY_TYPE", "ENTITY_ID", "ENTITY_NAME", "RISK_LEVEL", "CREATED_LOAD_ID", "DBT_UPDATED_AT", "CREATED_DATE_TIME", "UPDATED_DATE_TIME", "SCD_ID")
        values ("WATCHLIST_ID", "ENTITY_TYPE", "ENTITY_ID", "ENTITY_NAME", "RISK_LEVEL", "CREATED_LOAD_ID", "DBT_UPDATED_AT", "CREATED_DATE_TIME", "UPDATED_DATE_TIME", "SCD_ID")
