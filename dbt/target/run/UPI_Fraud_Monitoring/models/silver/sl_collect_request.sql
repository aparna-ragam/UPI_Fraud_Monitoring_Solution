...
create or replace transient table UPI_FRAUD_MONITORING_DB.TRANSFORM.sl_collect_request
    ...
    as (REQUEST_HOUR(Useful for detecting unusual transaction timings.)
---------------------------------------------------------------------------------------------
